...
public class GetCityByNameValidator : AbstractValidator<GetCityByNameInput>
{
    private readonly AppDbContext _ctx;
    private readonly IStringLocalizer<LocalizationMessage> _localizer;

    public GetCityByNameValidator(AppDbContext ctx, IStringLocalizer<LocalizationMessage> localizer)
    {
